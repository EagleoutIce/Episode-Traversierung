...
\newcommand*\tree[2][]{\downsize{\linewidth}{\begin{forest}for tree={lblob,minimum width=2.5em,s sep=4em-level*.5em,edge={line width=3pt,lgray,line cap=butt},#1}#2\end{forest}}}
\forestset{w/.style={fill=shadeGray,draw=shadeGray,edge={shadeGray}},m/.style={fill=shadeA,draw=shadeA,edge={shadeGray}},g/.style={fill=shadeA,draw=shadeA}}%
